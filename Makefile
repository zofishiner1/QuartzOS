...
# Безусловное обновление version.h
update_version:
	@echo "// Auto-generated by Makefile" > $(VERSION_HEADER)
	@echo "#pragma once" >> $(VERSION_HEADER)
	@echo "#define KERNEL_VERSION_MAJOR $(KERNEL_VERSION)" >> $(VERSION_HEADER)
	@echo "#define KERNEL_VERSION_MINOR $(KERNEL_PATCHLEVEL)" >> $(VERSION_HEADER)
	@echo "#define KERNEL_VERSION_PATCH $(KERNEL_SUBLEVEL)" >> $(VERSION_HEADER)
	@echo "#define KERNEL_VERSION_SUFFIX \"$(KERNEL_EXTRA)\"" >> $(VERSION_HEADER)
	@echo "#define KERNEL_VERSION_STRING \\" >> $(VERSION_HEADER)
	@echo "    \"$(KERNEL_VERSION).$(KERNEL_PATCHLEVEL).$(KERNEL_SUBLEVEL)$(KERNEL_EXTRA)\"" >> $(VERSION_HEADER)
...
# ============== ВЫВОД ВЕРСИИ ==============
version:
	@echo "Kernel version: $(KERNEL_VERSION).$(KERNEL_PATCHLEVEL).$(KERNEL_SUBLEVEL)$(KERNEL_EXTRA)"
